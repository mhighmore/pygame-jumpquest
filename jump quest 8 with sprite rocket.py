## TODO  need to add collision detection back in with sprite
import os
import random
import pygame
...
class Player(object):
    ...
    def move_single_axis(self, dx, dy):
        ...
        # TODO need to move to player sprite???
        for wall in walls:
            if self.rect.colliderect(wall.rect):
                if dx > 0:
                    self.rect.right = wall.rect.left
...
player = PlayerSprite() # rocket sprite as player
...
# the -1 is the loops, so here is infinite
